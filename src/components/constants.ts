...
export const laneModel = (carName: string, carId: string, carColor: string) => `
...
export const carHTML = (carName: string, carId: string, carColor: string) => `
<div class="car_name">${carName}</div>
<div class="car_model" id='${carId}'>
  <svg
    version="1.0"
